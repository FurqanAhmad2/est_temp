          ...
          <div className="col-lg-6">
            <div className="info">
              <div className="section-head style-9 mb-40">
                <h6 className=" wow fadeInUp"> about Estifix </h6>
                <h2 className=" wow fadeInUp"> Safeguard your Sites With Staging & Backups </h2>
              </div>
              <ul>
              ...
              <div className="call-info pt-40 mt-40 wow fadeInUp">
                <h5> Call (+971) 56 484 8434  or Chat Now </h5>
